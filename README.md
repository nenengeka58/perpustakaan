...
## Panduan Clone & Menjalankan di Device Berbeda
...
Edit file `.env` dan sesuaikan bagian berikut sesuai database di device Anda:
```
DB_CONNECTION=mysql
DB_HOST=127.0.0.1
DB_PORT=3306
...
#### **Panduan Khusus Windows/XAMPP**
1. Pastikan XAMPP sudah terinstall dan service MySQL berjalan.
2. Gunakan PHP dari XAMPP, misal:
    - `C:\xampp\php\php.exe artisan serve`
3. Jika `php` tidak dikenali, tambahkan path PHP XAMPP ke Environment Variable.
4. Database bisa dibuat lewat phpMyAdmin.

#### **Panduan Khusus Linux/MacOS/Docker**
1. Pastikan sudah install PHP, Composer, dan MySQL/MariaDB.
2. Ikuti langkah di atas, atau gunakan Docker/Makefile sesuai petunjuk di bawah.
